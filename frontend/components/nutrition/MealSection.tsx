    ...
    <div className="space-y-2">
      ...
      <Card>
        <CardContent className="p-0 divide-y">
          {entries.map((entry) => {
            const fav = favourites?.find((f) => f.food_name === entry.food_name)
            const isFavourited = Boolean(fav)
            return (
              <div
                key={entry.id}
              ...
              >
                ...
                <button
                  ...
                  className="p-1.5 rounded transition-all md:opacity-0 md:group-hover:opacity-100"
